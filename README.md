...
LayerTechnologyFrontendReact + TypeScript, served via nginxBackendFastAPI (Python)DatabasePostgreSQLContainerizationDocker, Docker ComposeOrchestrationKubernetes (via Kind — Kubernetes in Docker)
...
powershell# Create the cluster (first time only)
